  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% helicopter_DW.From_PWORK.TimePtr
	  ...
	  ;% helicopter_DW.Vd__PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 17;
	  section.data(3).dtTransOffset = 2;
	
	  ;% helicopter_DW.Vs__PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 18;
	  section.data(4).dtTransOffset = 3;
	
	  ;% helicopter_DW.u_input_PWORK.LoggedData
	  section.data(5).logicalSrcIdx = 19;
	  section.data(5).dtTransOffset = 4;
	
	  ;% helicopter_DW.From1_PWORK.TimePtr
	  section.data(6).logicalSrcIdx = 20;
	  section.data(6).dtTransOffset = 5;
	
	  ;% helicopter_DW.feedback_PWORK.LoggedData
	  section.data(7).logicalSrcIdx = 21;
	  section.data(7).dtTransOffset = 6;
	
	  ;% helicopter_DW.x_opt_PWORK.LoggedData
	  section.data(8).logicalSrcIdx = 22;
	  section.data(8).dtTransOffset = 7;
	
	  ;% helicopter_DW.x_state_PWORK.LoggedData
	  ...
	  ;% helicopter_DW.From_IWORK.PrevIndex
	  ...
	  ;% helicopter_DW.From1_IWORK.PrevIndex
  ...
  targMap.checksum0 = 2734771904;
  targMap.checksum1 = 978565335;
  targMap.checksum2 = 65775884;
  targMap.checksum3 = 767109761;
