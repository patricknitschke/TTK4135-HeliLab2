 ...
 * C source code generated on : Mon Feb 17 18:04:36 2020
 *
...
typedef struct {
  real_T From[2];                      /* '<S6>/From' */
  real_T Subtract1[2];                 /* '<S6>/Subtract1' */
  ...
  real_T Gain1[6];                     /* '<S3>/Gain1' */
  real_T Sum1;                         /* '<S5>/Sum1' */
  real_T Sum2;                         /* '<S5>/Sum2' */
  real_T K_ei;                         /* '<S7>/K_ei' */
  real_T Sum_g;                        /* '<S1>/Sum' */
  real_T From1[6];                     /* '<S6>/From1' */
  real_T Feedbackgain[2];              /* '<S6>/Feedback gain' */
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } u_input_PWORK;                     /* '<S6>/u_input' */

  struct {
    void *TimePtr;
    void *DataPtr;
    void *RSimInfoPtr;
  } From1_PWORK;                       /* '<S6>/From1' */

  struct {
    void *LoggedData;
  } feedback_PWORK;                    /* '<S6>/feedback' */

  struct {
    void *LoggedData;
  } x_opt_PWORK;                       /* '<S6>/x_opt' */

  struct {
    void *LoggedData;
  } x_state_PWORK;                     /* '<S6>/x_state' */
...
struct P_helicopter_T_ {
  ...
  real_T Integrator_LowerSat;          /* Expression: -inf
                                        * Referenced by: '<S7>/Integrator'
                                        */
  real_T travel_offset_Value;          /* Expression: 1*3.1415926
 ...
 *
 * '<Root>' : 'helicopter'
 * '<S1>'   : 'helicopter/Controller'
 * '<S2>'   : 'helicopter/Conversion'
 * '<S3>'   : 'helicopter/Degrees to Radians'
 * '<S4>'   : 'helicopter/Helicopter_interface'
 * '<S5>'   : 'helicopter/Controller/Basic Control layer'
 * '<S6>'   : 'helicopter/Controller/LQR'
 * '<S7>'   : 'helicopter/Controller/Basic Control layer/Elevation controller'
 * '<S8>'   : 'helicopter/Controller/Basic Control layer/Pitch controller'
